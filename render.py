...
# Description: Add render mode selection (supporting train and test mode)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, default="test", help="Rendering train or test images, default test")
    parser.add_argument("--surface", type=str, default=None, help="The ply file path of water surface for water editing. Default is None denotes no need for water editing.")
